<?php
    ...
    class MW{
        ...
        public function ValidarParametrosUsuario(Request $request, RequestHandler $handler) :ResponseMW{
            ...
            $params = json_decode($json['obj_json']);
        ...
        public static function VerificarUsuarioBD(Request $request, RequestHandler $handler) :ResponseMW{
            ...
            $usuario = Usuario::TraerUnoCorreoClave($json['obj_json']);
        ...
        public static function VerificarExistenciaCorreoBD(Request $request, RequestHandler $handler) :ResponseMW{
            ...
            $json = $request->getParsedBody();
            $json = json_decode($json['obj_json']);
        ...
        public function VerificarAutoMW(Request $request, RequestHandler $handler) :ResponseMW{
            ...
            $retorno = new stdClass();
            $retorno->mensaje = "El precio no esta en el rango valido y el auto es azul.";
            $retorno->status = 409;
            ...
            {
                $retorno->mensaje = "El color azul no esta permitido.";
            }
        ...
        public static function VerificarEncargadoPropietario(Request $request, RequestHandler $handler) :ResponseMW{
            ...
            if($usuario[0]->perfil == "propietario" || $usuario[0]->perfil == "encargado"){
                ...
                $respuesta->mensaje = "El usuario no es encargado ni propietario, quien quiso realizar la accion es: " . json_encode($usuario[0]);
                $responseMW->withStatus(409);
            }
            ...
            if(isset($payloadObtenido->payload)){
                ...
                $responseMW = new ResponseMW();
                    ...
                    if($usuario[0]->perfil == 'encargado'){
                        ...
                        $arrayDeAutos = $datosDeAutos->tabla;
                        ...
                        $datosDeAutos->tabla = $arrayDeAutos;
        ...
        public static function AccedePropietario(Request $request, RequestHandler $handler) :ResponseMW{
            ...
            $token = $request->getHeader("token")[0];
            $id= isset($request->getHeader("id")[0]) ? isset($request->getHeader("id")[0]) : NULL;
            ...
            if(isset($payloadObtenido->payload)){
                ...
                $responseMW = new ResponseMW();
                    ...
                    if($usuario[0]->perfil == 'encargado'){
                        ...
                        $datosDeUsuarios = $datosDeUsuarios->tabla;
            ...
            if(isset($payloadObtenido->payload)){
                ...
                $responseMW = new ResponseMW();
                    ...
                    if($usuario[0]->perfil == 'empleado'){
                        ...
                        $datosDeUsuarios->tabla = $datosDeUsuarios;
