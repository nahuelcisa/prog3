<?php
    ...
    class Auto
    {
        ...
        public function __construct($id = 0,$color = "",$marca = "",$precio = 0,$modelo = 0)
        {
            $this->id = $id;
            $this->color = $color;
            $this->marca = $marca;
        ...
        public static function ModificarAutomovil($json)
        {
            ...
            $query->bindValue(':modelo',$json->modelo, PDO::PARAM_INT);
            $query->bindValue(':id',$json->id, PDO::PARAM_INT);
        ...
        public function BorrarAuto(Request $request, Response $response, array $args) : Response{
            ...
            $retornoBorrado = json_decode(Auto::EliminarAuto($id));
