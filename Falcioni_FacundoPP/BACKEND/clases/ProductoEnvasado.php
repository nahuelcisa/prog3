<?php
    ...
    class ProductoEnvasado extends Producto implements IParte1, IParte2, IParte3
    {
        ...
        public static function Traer()
        {
            ...
            $query = $objetoAccesoDatos->RetornarConsulta("SELECT productos.id, productos.codigo_barra, productos.nombre,productos.origen,productos.precio,productos.foto AS pathFoto FROM productos");
            ...
            try
            {
                ...
                {
                    $producto = new ProductoEnvasado($item->nombre, $item->origen, $item->id, $item->codigo_barra, $item->precio, $item->pathFoto);
